    ...
    for agent_id in range(number_agents):
        ...
        for step_index in range(total_steps):
            ...
            for poi_id in range(number_pois):
                ...
                suggested_partners = homogeneous_partner_suggestions(n_counters, self_x, self_y, poi_id, poi_positions, poi_values)
                for partner_id in range(n_counters):
                    ...
                    observer_distances[number_agents + partner_id] = partner_dist
                    if observer_distances[agent_id] < min_obs_distance:
                        observer_count += 1
