...
parameters["generations"] = 1500  # Number of generations for CCEA in each stat run
parameters["pbank_generations"] = 1500  # Number of generations used for training policy bank
...
parameters["poi_config_type"] = "Random"  # Random, Two_POI, Four_Corners, Circle, Con_Circle, Four_Quadrants
...
parameters["n_policies"] = parameters["n_poi"]  # Number of pre-trained policies in the policy bank
parameters["n_suggestions"] = parameters["n_policies"]  # Number of suggestions a rover should learn
parameters["suggestion_type"] = "Unique"  # Identical, Unique, Random
parameters["s_inputs"] = 8
