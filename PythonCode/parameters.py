...
parameters["hazardous_poi"] = [0, 1, 2, 3, 4]  # ID numbers of POI that will be hazardous
...
parameters["steps"] = 15  # Number of time steps rovers take each episode
parameters["poi_config_type"] = "Two_POI"  # Random, Two_POI, Four_Corners, Circle, Con_Circle, Four_Quadrants, Columns
...
parameters["dmax"] = 2.25  # Maximum distance a rover can move in a single time step

# Suggestion Parameters
parameters["skill_type"] = "Target_POI"  # Target_Quadrant or Target_POI
parameters["custom_skills"] = False
