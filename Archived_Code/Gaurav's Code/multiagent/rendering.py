...
class Viewer(object):
    def __init__(self, width, height, display=None):
        ...
        self.cam_range = 1      # zoom = 1x sizes
    ...
    def set_bounds(self, left, right, bottom, top):
        # apply camera zoom
        left = left - self.cam_range
        right = right + self.cam_range
        bottom = bottom - self.cam_range
        top = top + self.cam_range
        # assert bounds are okay
