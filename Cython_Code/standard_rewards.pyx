...
# GLOBAL REWARD SPATIALLY COUPLED POI ------------------------------------------------------------------------------
cpdef calc_g_spatial(object p, double [:, :, :] rover_paths, double[:, :] pois):
    """
    Calculate the global reward for the entire rover trajectory
    :param rover_paths:
    :param poi_values:
...
# DIFFERENCE REWARDS SPATIALLY COUPLED POI----------------------------------------------------------------------------
cpdef calc_d_spatial(object p, double [:, :, :] rover_paths, double [:, :] pois, double global_reward):
    """
    Calcualte each rover's difference reward from entire rover trajectory
    :param rover_paths:
    :param poi_values:
...
# D++ REWARD SPATIALLY COUPLED POI -----------------------------------------------------------------------------------
cpdef calc_dpp_spatial(object p, double [:, :, :] rover_paths, double [:, :] pois, double global_reward):
    """
    Calculate D++ rewards for each rover across entire trajectory
    :param sgst: 
    :param rover_paths:
