...
g_data_c1 = importdata('C1/Global/Output_Data/Final_GlobalRewards.csv');
g_data_c2 = importdata('C2/Global/Output_Data/Final_GlobalRewards.csv');
g_data_c3 = importdata('C3/Global/Output_Data/Final_GlobalRewards.csv');

% Difference Rewards Data
d_data_same = importdata('Same/Difference/Output_Data/Final_GlobalRewards.csv');
d_data_c1 = importdata('C1/Difference/Output_Data/Final_GlobalRewards.csv');
d_data_c2 = importdata('C2/Difference/Output_Data/Final_GlobalRewards.csv');
d_data_c3 = importdata('C3/Difference/Output_Data/Final_GlobalRewards.csv');

% D++ Rewards Data
dpp_data_same = importdata('Same/DPP/Output_Data/Final_GlobalRewards.csv');
dpp_data_c1 = importdata('C1/DPP/Output_Data/Final_GlobalRewards.csv');
dpp_data_c2= importdata('C2/DPP/Output_Data/Final_GlobalRewards.csv');
dpp_data_c3 = importdata('C3/DPP/Output_Data/Final_GlobalRewards.csv');

% S-D++(1) Reward Data
sdpp1_data_same = importdata('Same/SDPP1/Output_Data/Final_GlobalRewards.csv');
sdpp1_data_c1 = importdata('C1/SDPP1/Output_Data/Final_GlobalRewards.csv');
sdpp1_data_c2= importdata('C2/SDPP1/Output_Data/Final_GlobalRewards.csv');
sdpp1_data_c3 = importdata('C3/SDPP1/Output_Data/Final_GlobalRewards.csv');

% S-D++(2) Reward Data
sdpp2_data_same = importdata('Same/SDPP2/Output_Data/Final_GlobalRewards.csv');
sdpp2_data_c1 = importdata('C1/SDPP2/Output_Data/Final_GlobalRewards.csv');
sdpp2_data_c2= importdata('C2/SDPP2/Output_Data/Final_GlobalRewards.csv');
sdpp2_data_c3 = importdata('C3/SDPP2/Output_Data/Final_GlobalRewards.csv');

% CBM Data
cbm_data_same = importdata('Same/CBM/Output_Data/Final_GlobalRewards.csv');
cbm_data_c1 = importdata('C1/CBM/Output_Data/Final_GlobalRewards.csv');
cbm_data_c2 = importdata('C2/CBM/Output_Data/Final_GlobalRewards.csv');
cbm_data_c3 = importdata('C3/CBM/Output_Data/Final_GlobalRewards.csv');
...
g_fitness = [gf0, gf1, gf2, gf3];
g_error = [ge0, ge1, ge2, ge3];
...
d_fitness = [df0, df1, df2, df3];
d_error = [de0, de1, de2, de3];
...
dpp_fitness = [dppf0, dppf1, dppf2, dppf3];
dpp_error = [dppe0, dppe1, dppe2, dppe3];
...
sdpp1_fitness = [sdpp1f0, sdpp1f1, sdpp1f2, sdpp1f3];
sdpp1_error = [sdpp1e0, sdpp1e1, sdpp1e2, sdpp1e3];
...
sdpp2_fitness = [sdpp2f0, sdpp2f1, sdpp2f2, sdpp2f3];
sdpp2_error = [sdpp2e0, sdpp2e1, sdpp2e2, sdpp2e3];
...
cbm_fitness = [sf0, sf1, sf2, sf3];
cbm_error = [cbme0, cbme1, cbme2, cbme3];
...
lgd.FontSize = 12;
set(gca, 'xticklabel', {'C0', 'C1', 'C2', 'C3'})
