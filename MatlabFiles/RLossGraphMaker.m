...
g_data_c1 = importdata('R1/Global/Output_Data/Final_GlobalRewards.csv');
g_data_c2 = importdata('R2/Global/Output_Data/Final_GlobalRewards.csv');
g_data_c3 = importdata('R3/Global/Output_Data/Final_GlobalRewards.csv');

% Difference Rewards Data
d_data_same = importdata('Same/Difference/Output_Data/Final_GlobalRewards.csv');
d_data_c1 = importdata('R1/Difference/Output_Data/Final_GlobalRewards.csv');
d_data_c2 = importdata('R2/Difference/Output_Data/Final_GlobalRewards.csv');
d_data_c3 = importdata('R3/Difference/Output_Data/Final_GlobalRewards.csv');

% D++ Rewards Data
dpp_data_same = importdata('Same/DPP/Output_Data/Final_GlobalRewards.csv');
dpp_data_c1 = importdata('R1/DPP/Output_Data/Final_GlobalRewards.csv');
dpp_data_c2= importdata('R2/DPP/Output_Data/Final_GlobalRewards.csv');
dpp_data_c3 = importdata('R3/DPP/Output_Data/Final_GlobalRewards.csv');

% S-D++(1) Reward Data
sdpp1_data_same = importdata('Same/SDPP1/Output_Data/Final_GlobalRewards.csv');
sdpp1_data_c1 = importdata('R1/SDPP1/Output_Data/Final_GlobalRewards.csv');
sdpp1_data_c2= importdata('R2/SDPP1/Output_Data/Final_GlobalRewards.csv');
sdpp1_data_c3 = importdata('R3/SDPP1/Output_Data/Final_GlobalRewards.csv');

% S-D++(2) Reward Data
sdpp2_data_same = importdata('Same/SDPP2/Output_Data/Final_GlobalRewards.csv');
sdpp2_data_c1 = importdata('R1/SDPP2/Output_Data/Final_GlobalRewards.csv');
sdpp2_data_c2= importdata('R2/SDPP2/Output_Data/Final_GlobalRewards.csv');
sdpp2_data_c3 = importdata('R3/SDPP2/Output_Data/Final_GlobalRewards.csv');

% CBM Data
cbm_data_same = importdata('Same/CBM/Output_Data/Final_GlobalRewards.csv');
cbm_data_c1 = importdata('R1/CBM/Output_Data/Final_GlobalRewards.csv');
cbm_data_c2 = importdata('R2/CBM/Output_Data/Final_GlobalRewards.csv');
cbm_data_c3 = importdata('R3/CBM/Output_Data/Final_GlobalRewards.csv');
